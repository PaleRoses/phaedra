...
use ::image::RgbaImage;
use phaedra_cell::color::RgbColor;
use phaedra_cell::image::ImageDataType;
use phaedra_escape_parser::{Sixel, SixelData};
        ...
        for d in &sixel.data {
            match d {
                ...
                SixelData::DefineColorMapHSL {
                    ...
                    // https://github.com/PaleRoses/phaedra/issues/775
