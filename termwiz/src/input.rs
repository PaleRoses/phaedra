...
use std::fmt::Write;
use phaedra_input_types::ctrl_mapping;

pub use phaedra_input_types::Modifiers;
...
pub use phaedra_escape_parser::csi::MouseButtons;
            ...
            match self.state {
                InputState::Pasting(offset) => {
                    ...
                    if let Some(idx) = self.buf.find_subsequence(offset, end_paste) {
                        ...
                        // <https://github.com/PaleRoses/phaedra/pull/1832>
                        self.state =
