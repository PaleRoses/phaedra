...
phaedra.action.SpawnCommandInNewWindow {
  ...
  -- If omitted, phaedra will infer a value based on the active pane
  ...
  -- phaedra using `phaedra connect` or `phaedra serial` then the default
  ...
  -- phaedra.mux.spawn_window, SpawnCommandInNewWindow
  position = {
    x = 10,
    y = 300,
