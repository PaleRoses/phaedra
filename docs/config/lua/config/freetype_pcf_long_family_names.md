...
## Why doesn't phaedra use the distro FreeType or match its configuration?

For the sake of consistency, phaedra vendors in its own copy of
...
version of phaedra are the same on all platforms regardless of
