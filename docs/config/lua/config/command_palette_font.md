...
You will typically use [phaedra.font](../phaedra/font.md) or
[phaedra.font_with_fallback](../phaedra/font_with_fallback.md) to specify the
font.

To specify `command_palette_font`:

```lua
config.command_palette_font = phaedra.font 'Roboto'
```
