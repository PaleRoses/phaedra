...
In this mode, if the application hasn't enabled mouse reporting, phaedra will
...
In versions of phaedra prior to this configuration option being available, the
