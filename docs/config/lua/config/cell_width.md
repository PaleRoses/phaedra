...
selecting a font using [phaedra.font](../phaedra/font.md) or
[phaedra.font_with_fallback](../phaedra/font_with_fallback.md) as that will
...
phaedra considers to be the cell boundaries. When rendering monospace, phaedra
