...
You can use the [phaedra.gui.enumerate_gpus()](../phaedra.gui/enumerate_gpus.md) function
...
local config = {}
local gpus = phaedra.gui.enumerate_gpus()
...
for _, gpu in ipairs(phaedra.gui.enumerate_gpus()) do
