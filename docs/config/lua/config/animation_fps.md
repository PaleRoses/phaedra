...
If you are running without GPU acceleration (for example, your system
doesn't have a compatible GPU), then setting `animation_fps = 1` is
recommended, as doing so will disable easing effects and use transitions:
