---
title: phaedra.gradient_colors
tags:
 - color
---

# `phaedra.gradient_colors(gradient, num_colors)`
...
```
> phaedra.gradient_colors({preset="Rainbow"}, 4)
...
[phaedra.color.gradient](../phaedra.color/gradient.md) and that name
