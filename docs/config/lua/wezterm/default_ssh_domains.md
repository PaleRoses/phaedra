---
title: phaedra.default_ssh_domains
tags:
 - ssh
 - multiplexing
---

# phaedra.default_ssh_domains()
...
require phaedra to be installed on the remote host, while the
