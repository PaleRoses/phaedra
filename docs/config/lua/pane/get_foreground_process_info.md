...
* Querying the path may fail for a variety of reasons outside of the control of Phaedra
* Querying process information has some runtime overhead, which may cause phaedra to slow down if over-used.
