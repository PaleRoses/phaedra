...
Defining an event handler doesn't alter phaedra's handling of the bell;
...
phaedra.on('bell', function(window, pane)
  phaedra.log_info('the bell was rung in pane ' .. pane:pane_id() .. '!')
end)
