...
option, `phaedra` supports defining additional named key tables using the
...
Each `phaedra` GUI window maintains a stack of activations, which allows you to
...
yourself by re-saving your phaedra configuration to trigger a reload.
