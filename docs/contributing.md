...
* [Phaedra on GitHub](https://github.com/wezterm/wezterm)
...
* [Where to find things and hacking on phaedra](https://github.com/wezterm/wezterm/blob/master/CONTRIBUTING.md#contributing-to-wezterm)
...
make Phaedra look cooler, I'd also welcome your contribution!
