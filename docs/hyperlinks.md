phaedra has support for both implicit and explicit hyperlinks.
...
config.hyperlink_rules = phaedra.default_hyperlink_rules()
...
-- ( "nvim-treesitter/nvim-treesitter" | wbthomason/packer.nvim | phaedra/phaedra | "phaedra/phaedra.git" )
...
[default_hyperlink_rules](config/lua/phaedra/default_hyperlink_rules.md).


### Explicit Hyperlinks

phaedra supports the relatively new [Hyperlinks in Terminal
