# `phaedra cli send-text`

*Run `phaedra cli send-text --help` to see more help*
...
```
$ phaedra cli send-text "hello there"
```
...
```
$ echo hello there | phaedra cli send-text
```
...
```console
{% include "../../examples/cmd-synopsis-phaedra-cli-send-text--help.txt" %}
```
