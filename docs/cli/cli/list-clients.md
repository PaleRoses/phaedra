# `phaedra cli list-clients`

*Run `phaedra cli list-clients --help` to see more help*
...
```
$ phaedra cli list-clients --format json
[
  {
    "username": "wez",
    "hostname": "foo",
...
```console
{% include "../../examples/cmd-synopsis-phaedra-cli-list-clients--help.txt" %}
```
