...
*Run `phaedra cli list --help` to see more help*
...
WINID TABID PANEID WORKSPACE SIZE  TITLE                          CWD
    0     0      0 default   80x24 phaedra cli list  -- wez@foo:~ file://foo/home/wez/
```
...
[
  {
    ...
    "title": "phaedra cli list --format json -- wez@foo:~",
...
```console
{% include "../../examples/cmd-synopsis-phaedra-cli-list--help.txt" %}
```
