# `phaedra cli get-text`

{{since('20230320-124340-559cb7b0')}}

*Run `phaedra cli get-text --help` to see more help*
...
```
$ phaedra cli get-text > /tmp/myscreen.txt
```
...
```
$ phaedra cli get-text --escapes > /tmp/myscreen-with-colors.txt
```
...
```console
{% include "../../examples/cmd-synopsis-phaedra-cli-get-text--help.txt" %}
```
