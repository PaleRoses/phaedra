        ...
        match value {
            ...
            other => {
                if let Some(value) = value.coerce_unsigned() {
                    ...
                    Err(phaedra_dynamic::Error::NoConversion {
...
pub struct StyleRule {
    ...
    /// "Half".
    pub intensity: Option<phaedra_term::Intensity>,
    ...
    /// "Double".
    pub underline: Option<phaedra_term::Underline>,
    ...
    /// a value that matches this rule.
    pub blink: Option<phaedra_term::Blink>,
