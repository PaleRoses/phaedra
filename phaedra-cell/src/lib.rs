...
pub use phaedra_char_props::emoji::Presentation;
use phaedra_char_props::emoji_variation::WCWIDTH_TABLE;
use phaedra_char_props::widechar_width::WcWidth;
use phaedra_dynamic::{FromDynamic, ToDynamic};
pub use phaedra_escape_parser::osc::Hyperlink;
...
pub use phaedra_escape_parser::csi::{Blink, Intensity, Underline, VerticalAlign};
...
pub fn is_white_space_char(c: char) -> bool {
    phaedra_char_props::white_space::WHITE_SPACE.contains_u32(c as u32)
}
...
mod test {
    ...
    // That decision is made over in phaedra-term when processing
