...
use phaedra_cell::color::ColorAttribute;
#[cfg(feature = "use_image")]
use phaedra_cell::image::ImageCell;
use phaedra_cell::{Cell, CellAttributes};
...
mod test {
    use super::*;
    use alloc::sync::Arc;
    use phaedra_cell::color::AnsiColor;
    use phaedra_cell::image::ImageData;
    use phaedra_cell::{AttributeChange, Intensity};
