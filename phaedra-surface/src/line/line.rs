...
#[cfg(feature = "appdata")]
use std::sync::Mutex;
use phaedra_bidi::{Direction, ParagraphDirectionHint};
use phaedra_cell::{Cell, CellAttributes, SemanticType, UnicodeVersion};
...
impl Line {
    ...
    pub fn split_off(&mut self, idx: usize, seqno: SequenceNo) -> Self {
        ...
        // <https://github.com/PaleRoses/phaedra/issues/2355>
    ...
    fn set_cell_impl(&mut self, idx: usize, cell: Cell, clear: bool, seqno: SequenceNo) {
        ...
        // https://github.com/PaleRoses/phaedra/issues/768
